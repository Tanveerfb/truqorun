...
export const metadata: Metadata = {
  ...
  description:
    "Explore our comprehensive web development services including business landing pages, e-commerce, CMS solutions, and maintenance.",
};
          ...
          <Container size="lg">
            <div className="text-center">
              ...
              <Paragraph size="lg" className="mx-auto max-w-3xl">
                ...
                templates, no website builders—just clean, modern code that
                drives results.
              </Paragraph>
            </div>
          </Container>
