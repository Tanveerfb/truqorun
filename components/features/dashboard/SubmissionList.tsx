...
type StatusFilter = 'all' | 'new' | 'contacted' | 'in-progress' | 'completed' | 'archived';
...
export const SubmissionList: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between rounded-lg border border-input-border bg-white p-4 dark:bg-gray-900">
      ...
      {filteredSubmissions.length === 0 ? (
        <div className="rounded-lg border border-input-border bg-white p-12 text-center dark:bg-gray-900">
  ...
  return [
    {
      ...
      budget: '4k-7k',
      timeline: '1-2-months',
      projectBrief: 'We need an e-commerce platform for our retail business. Looking for a modern, mobile-friendly solution with payment processing.',
    ...
    },
    {
      ...
      budget: '1k-2k',
      timeline: '1-2-weeks',
      projectBrief: 'Simple landing page for our new product launch. Need it fast!',
